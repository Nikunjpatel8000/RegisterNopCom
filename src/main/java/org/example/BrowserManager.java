...
public class BrowserManager extends Util {//BrowserManager is sub class of Util class
    ...
    public static final boolean SAUCE_LAB = Boolean.parseBoolean(System.getProperty("SauceLab"));
...
//                options.addArguments("--incognito");
        ...
        driver.manage().timeouts().implicitlyWait(120, TimeUnit.SECONDS);//wait for 60 second before all test case
